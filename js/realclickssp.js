...
function loadRealSSP(mo, m, t, v, eff) {
    ...
    var processScroll = function(){
        clearTimeout(reloadTimer_interworks00021_4033);
        ...
        if(!load){
            if(t=='i') {
                ...
                if(elementInViewport(mo)) {
                    ...
                    so.setAttribute("src", "//nw.realssp.co.kr/?v="+v+"&m="+mo.getAttribute('data-mcode')+"&s=&passback=");
            ...
            if(eff != 'off' && document.getElementById("real_ad_ui_interworks00021_4033")) {
                if(new RegExp('(\\s|^)real_toast(\\s|$)').test(document.getElementById("real_ad_ui_interworks00021_4033").className)) {
                    changeOpacity("real_ad_ui_interworks00021_4033", 0);
                    reloadTimer_interworks00021_4033 = setTimeout("realFadeIn(\'real_ad_ui_interworks00021_4033\')", 500);
                }
            }
        }
    };
...
var mo_interworks00021_4033=document.getElementById("realssp_interworks00021_4033");
var reloadTimer_interworks00021_4033;
loadRealSSP(mo_interworks00021_4033, "interworks00021_4033", "j", "1.0", "");
